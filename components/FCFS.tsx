  ...
  return (
    <div className="w-full">
      <h3 className="mb-3 font-bold text-blue-500">
        <span className="mr-3 text-blue-700">1.2.1</span> FCFS CPU SCHEDULING
        ALGORITHM
      </h3>
      <h5 className="mb-8 text-justify">
        For FCFS scheduling algorithm, read the number of processes/jobs in the
        system, their CPU burst times. The scheduling is performed on the basis
        of arrival time of the processes irrespective of their other parameters.
        Each process will be executed according to its arrival time. Calculate
            ...
            <div className="w-full mb-6">
              ...
              {job?.map((j, i) => (
                ...
                >
                  ...
                  <div className="col-span-2 text-sm text-center">{j}</div>
